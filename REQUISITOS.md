...
Este documento descreve os requisitos funcionais e não funcionais que guiam o desenvolvimento da plataforma de conteúdo esportivo.
...
- **RF07 – Escolha de time favorito:** O sistema deve permitir que o usuário escolha e defina seu time favorito.
...
- **RF10 – Área do usuário:** O sistema deve disponibilizar uma área específica para o usuário após a realização do login.
